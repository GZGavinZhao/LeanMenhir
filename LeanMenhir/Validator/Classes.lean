...
`b = true → P` implications (and, for safety, the converse) by hand. This file
collects the reusable lemmas (`forallb`-style combinators) used by both
`Validator/Safe` and `Validator/Complete`.
-/
...
that powers the `Decidable safe` instance. -/
